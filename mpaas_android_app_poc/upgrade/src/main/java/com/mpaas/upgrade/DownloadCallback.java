        ...
        if (null != upgradeActivity) {
            upgradeActivity.runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText(upgradeActivity, upgradeActivity.getString(com.mpaas.demo.upgrade.R.string.download_cancel), Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
    ...
    public void onFinish(UpgradeDownloadRequest upgradeDownloadRequest, final String savePath) {
        ...
        if (null != upgradeActivity) {
            upgradeActivity.runOnUiThread(new Runnable() {
                ...
                public void run() {
                    upgradeActivity.cancelDownloadProgressDialog();
                    Toast.makeText(upgradeActivity, upgradeActivity.getString(com.mpaas.demo.upgrade.R.string.download_finish), Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
    ...
    public void onFailed(UpgradeDownloadRequest upgradeDownloadRequest, int errorCode, String errorMessage) {
        ...
        if (null != upgradeActivity) {
            upgradeActivity.runOnUiThread(new Runnable() {
                ...
                public void run() {
                    upgradeActivity.cancelDownloadProgressDialog();
                    Toast.makeText(upgradeActivity, upgradeActivity.getString(com.mpaas.demo.upgrade.R.string.download_exception), Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
