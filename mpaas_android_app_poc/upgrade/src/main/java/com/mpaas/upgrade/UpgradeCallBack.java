        ...
        if (null != upgradeActivity) {
            upgradeActivity.runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText(upgradeActivity, upgradeActivity.getString(com.mpaas.demo.upgrade.R.string.warning_updating), Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
    ...
    public void onException(Throwable throwable) {
        ...
        if (null != upgradeActivity) {
            upgradeActivity.runOnUiThread(new Runnable() {
                ...
                public void run() {
                    upgradeActivity.cancelCheckUpgradeProgressDialog();
                    Toast.makeText(upgradeActivity, upgradeActivity.getString(com.mpaas.demo.upgrade.R.string.upgrade_exception), Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
    ...
    public void dealDataInValid(Activity activity, ClientUpgradeRes clientUpgradeRes) {
        ...
        if (null != upgradeActivity) {
            upgradeActivity.runOnUiThread(new Runnable() {
                ...
                public void run() {
                    upgradeActivity.cancelCheckUpgradeProgressDialog();
                    Toast.makeText(upgradeActivity, upgradeActivity.getString(com.mpaas.demo.upgrade.R.string.data_invalid), Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
    ...
    public void dealHasNoNewVersion(Activity activity, ClientUpgradeRes clientUpgradeRes) {
        ...
        if (null != upgradeActivity) {
            upgradeActivity.runOnUiThread(new Runnable() {
                ...
                public void run() {
                    upgradeActivity.cancelCheckUpgradeProgressDialog();
                    Toast.makeText(upgradeActivity, upgradeActivity.getString(com.mpaas.demo.upgrade.R.string.has_no_new_version), Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
    ...
    public void onLimit(Activity activity, ClientUpgradeRes clientUpgradeRes, final String reason) {
        ...
        if (null != upgradeActivity) {
            upgradeActivity.runOnUiThread(new Runnable() {
                ...
                public void run() {
                    upgradeActivity.cancelCheckUpgradeProgressDialog();
                    Toast.makeText(upgradeActivity, upgradeActivity.getString(com.mpaas.demo.upgrade.R.string.upgrade_less_than_interval), Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
