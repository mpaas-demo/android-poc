...
import com.mpaas.tinyapp.TinyAppSettingActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_fast_start).setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(MainActivity.this, TinyAppSettingActivity.class));
            }
        });
        //高德地图
        ...
        //安全键盘
        findViewById(R.id.btn_safekeyboard).setOnClickListener(new OnClickListener() {

            @Override
            public void onClick(View v) {
                MPLogger.info(Tag, "safekeyboard");
                MPLogger.error(Tag, "safekeyboard");
                String logId = "safekeyboard";
                // bizType 标识业务类型，相同 bizType 的自定义日志将遵循同样的上报策略，存储在同一个文件中，文件名为进程名_bizType
                // bizType 可以为空，默认为 userbehavor
                String bizType = "Pay";
                // params 为自定义参数，控制台自定义分析中事件的自定义属性对应这些键值对
                ...
                params.put("time", "2021-07-15");
                MPLogger.event(logId, bizType, params);
                Intent intent = new Intent(MainActivity.this, PocActivity.class);
                startActivity(intent);
            }
        });
        ...
        //H5双向通信
        findViewById(R.id.btn_h5).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                MPLogger.info(Tag, "H5双向通信");
                MPLogger.error(Tag, "H5双向通信");
