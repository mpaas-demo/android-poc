...
public class AutomationActivity extends BaseFragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // MPLogger.enableAutoLog();
        ...
        TabLayout tabLayout = (TabLayout) findViewById(com.mpaas.demo.analytics.R.id.tab);
    ...
    private void changeFragment(int tab) {
        if (selectedTab != tab) {
            ...
            if (!f.isAdded()) {
                transaction.add(com.mpaas.demo.analytics.R.id.container, f).commitAllowingStateLoss();
            } else {
